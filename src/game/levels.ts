...
// Seven acts. The level pacing itself carries the story: comfort -> suspicion -> loss -> revelation -> intrusion -> transformation -> choice.
export const LEVELS: LevelDef[] = [
  {
    ...
    intro: ["d.intro.1", "d.intro.2", "d.intro.3", "d.l1.sign"], npcs: [],
    ...
    triggers: [
      { x: 500, y: 0, w: 70, h: H, event: "dialogue", key: "d.l1.sign", once: true },
      { x: 1180, y: 0, w: 70, h: H, event: "dialogue", key: "d.l1.cottage", once: true },
      { x: 2050, y: 0, w: 70, h: H, event: "dialogue", key: "d.l1.mid", once: true },
      { x: 2860, y: 0, w: 70, h: H, event: "dialogue", key: "d.note", once: true },
      { x: 3500, y: 0, w: 70, h: H, event: "look", key: "d.l1.end", once: true },
      { x: 3850, y: 0, w: 70, h: H, event: "dialogue", key: "d.l1.end", once: true },
    ]
  },
  {
    id: 2, width: 4400, height: H, sky: "/maps/fog-sky.jpg", far: "/maps/fog-far.jpg", fog: "/maps/fog-overlay.png", plat: "grass",
    spawn: { x: 180, y: 500 }, exit: { x: 4250, y: G - 168, w: 120, h: 168 },
    intro: ["d.l2.start", "d.l2.look", "d.l2.end"], npcs: [],
    ...
    triggers: [
      { x: 720, y: 0, w: 60, h: H, event: "dialogue", key: "d.l2.start", once: true },
      { x: 1200, y: 0, w: 60, h: H, event: "look", key: "d.l2.look", once: true },
      { x: 2050, y: 0, w: 60, h: H, event: "whisper", key: "whisper.1", once: true },
      { x: 2500, y: 0, w: 60, h: H, event: "glitch", once: true },
      { x: 2900, y: 0, w: 60, h: H, event: "dialogue", key: "d.l2.look", once: true },
      { x: 3500, y: 0, w: 60, h: H, event: "stare", key: "d.l2.end", once: true },
      { x: 4100, y: 0, w: 70, h: H, event: "dialogue", key: "d.l2.end", once: true },
    ]
  },
  {
    id: 3, width: 4600, height: H, sky: "/maps/blood-sky.jpg", far: "/maps/blood-far.jpg", fog: "/maps/blood-fog.png", plat: "blood",
    spawn: { x: 180, y: 500 }, exit: { x: 4450, y: G - 168, w: 120, h: 168 },
    intro: ["d.l3.start", "d.l3.poster", "d.l3.whisper", "d.l3.end"], npcs: [],
    ...
    triggers: [
      { x: 650, y: 0, w: 50, h: H, event: "dialogue", key: "d.l3.poster", once: true },
      { x: 1300, y: 0, w: 50, h: H, event: "red", key: "red.1", once: true },
      { x: 1900, y: 0, w: 50, h: H, event: "dialogue", key: "d.l3.whisper", once: true },
      { x: 2450, y: 0, w: 50, h: H, event: "black", key: "black.2", once: true },
      { x: 3000, y: 0, w: 50, h: H, event: "red", key: "red.2", once: true },
      { x: 3550, y: 0, w: 50, h: H, event: "look", key: "d.l3.end", once: true },
      { x: 4250, y: 0, w: 60, h: H, event: "red", key: "red.6", once: true },
    ]
  },
  {
    id: 4, width: 4700, height: H, sky: "/maps/void-sky.jpg", far: "/maps/void-far.jpg", plat: "glitch",
    spawn: { x: 180, y: 500 }, exit: { x: 4550, y: G - 168, w: 120, h: 168 },
    intro: ["d.l4.start", "d.l4.comp", "d.l4.after"], npcs: [],
    ...
    triggers: [
      { x: 1050, y: 0, w: 50, h: H, event: "dialogue", key: "d.l4.comp", once: true },
      { x: 1650, y: 0, w: 50, h: H, event: "glitch", once: true },
      { x: 2050, y: 0, w: 50, h: H, event: "bsod", once: true },
      { x: 2850, y: 0, w: 50, h: H, event: "dialogue", key: "d.l4.after", once: true },
      { x: 3350, y: 0, w: 50, h: H, event: "black", key: "black.1", once: true },
      { x: 4100, y: 0, w: 50, h: H, event: "red", key: "red.3", once: true },
      { x: 4400, y: 0, w: 50, h: H, event: "whisper", key: "whisper.2", once: true },
    ]
  },
  {
    id: 5, width: 4700, height: H, sky: "/maps/desktop-corrupt.jpg", far: "/maps/forest-far.jpg", plat: "stone",
    spawn: { x: 180, y: 500 }, exit: { x: 4550, y: G - 168, w: 120, h: 168 },
    intro: ["d.l5.1", "d.l5.2", "d.l5.3", "d.l5.stare"], npcs: [],
    platforms: [ground(0, 800, "stone"), plat(880, 520, 180, "wood"), plat(1130, 430, 180, "stone"), ground(1370, 650, "stone"), plat(1590, 500, 190, "wood"), plat(1860, 390, 180, "stone"), ground(2080, 650, "stone"), plat(2300, 490, 190, "wood"), plat(2580, 370, 180, "stone"), ground(2800, 700, "stone"), plat(3050, 490, 190, "wood"), mover(3330, 500, 170, "stone", 140, 0, 2800), plat(3650, 390, 180, "stone"), ground(3880, 700, "stone")],
    ...
    triggers: [
      { x: 900, y: 0, w: 50, h: H, event: "dialogue", key: "d.l5.1", once: true },
      { x: 1450, y: 0, w: 50, h: H, event: "windows", once: true },
      { x: 2100, y: 0, w: 50, h: H, event: "stare", key: "d.l5.stare", once: true },
      { x: 2750, y: 0, w: 50, h: H, event: "glitch", once: true },
      { x: 3150, y: 0, w: 50, h: H, event: "cursor", once: true },
      { x: 3600, y: 0, w: 50, h: H, event: "dialogue", key: "d.l5.2", once: true },
      { x: 4000, y: 0, w: 50, h: H, event: "red", key: "red.8", once: true },
    ]
  },
  {
    id: 6, width: 4800, height: H, sky: "/maps/glitch-far.jpg", far: "/maps/glitch-far.jpg", plat: "void",
    spawn: { x: 180, y: 500 }, exit: { x: 4650, y: G - 168, w: 120, h: 168 }, intro: ["d.l6.1", "d.l6.2", "d.l6.gem"], gravity: 1, npcs: [],
    ...
    triggers: [
      { x: 1200, y: 0, w: 50, h: H, event: "dialogue", key: "d.l6.gem", once: true },
      { x: 1450, y: 0, w: 50, h: H, event: "distort", once: true },
      { x: 2100, y: 0, w: 50, h: H, event: "shake", once: true },
      { x: 2500, y: 0, w: 50, h: H, event: "glitch", once: true },
      { x: 3250, y: 0, w: 50, h: H, event: "red", key: "red.4", once: true },
      { x: 3750, y: 0, w: 50, h: H, event: "look", key: "red.4", once: true },
      { x: 4100, y: 0, w: 50, h: H, event: "black", key: "black.1", once: true },
      { x: 4400, y: 0, w: 50, h: H, event: "red", key: "red.5", once: true },
    ]
  },
  {
    ...
    triggers: [
      { x: 700, y: 0, w: 60, h: H, event: "black", key: "black.1", once: true },
      { x: 1120, y: 0, w: 60, h: H, event: "glitch", once: true },
      { x: 1540, y: 0, w: 60, h: H, event: "stare", key: "d.fin.look", once: true },
      { x: 1900, y: 0, w: 60, h: H, event: "dialogue", key: "d.fin.3", once: true },
      { x: 2250, y: 0, w: 60, h: H, event: "red", key: "red.7", once: true },
